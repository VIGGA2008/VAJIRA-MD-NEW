...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=uJsHmDyL#WCwrlUDlI_WOmyC9yqCwvpU4zoThh62A5kKBqJCUsck' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '+94765382845' : process.env.OWNER_NUMBER,   
